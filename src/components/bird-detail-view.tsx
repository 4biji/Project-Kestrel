...
const defaultLayouts: Responsive.Layouts = {
    lg: [
      { i: 'weight-trend', x: 0, y: 0, w: 4, h: 1 },
      { i: 'weight-log', x: 0, y: 1, w: 1, h: 3 },
      { i: 'feeding-log', x: 1, y: 1, w: 1, h: 3 },
      { i: 'training-log', x: 2, y: 1, w: 1, h: 3 },
      { i: 'hunting-log', x: 3, y: 1, w: 1, h: 3 },
      { i: 'husbandry', x: 0, y: 4, w: 1, h: 3 },
      { i: 'mutes-castings', x: 1, y: 4, w: 1, h: 3 },
    ],
};
