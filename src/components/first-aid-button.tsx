  ...
  return (
    ...
    >
      <div className="relative w-3 h-3">
        <div className="absolute top-1/2 left-0 w-full h-[2px] bg-white -translate-y-1/2 rounded-full"></div>
        <div className="absolute top-0 left-1/2 w-[2px] h-full bg-white -translate-x-1/2 rounded-full"></div>
      </div>
      <span className="font-bold text-xs">First Aid</span>
    </Button>
  );
}
