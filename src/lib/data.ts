...
import type { Bird, LogEntry, NutritionInfo, PredefinedHusbandryTask, PredefinedTraining } from './types';
...
export const logs: LogData = {
  ...
  'b2': [
    ...
    { logType: 'mute', id: 'm-b2-1', datetime: '2024-07-22T07:00:00', condition: 'Normal', notes: '' },
